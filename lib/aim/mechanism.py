...
# Source: https://github.com/ryan112358/private-pgm/blob/master/mechanisms/mechanism.py
# Used under the Apache-2.0 license 

# Modifications: 
# use local code
# add rho_divider to Mechanism constructor to facilitate splitting the privacy budget

import numpy as np
from autodp import privacy_calibrator
from functools import partial
from lib.aim.cdp2adp import cdp_rho
...
class Mechanism:
    def __init__(self, epsilon, delta, bounded, prng=np.random, rho_divider=1):
        """
        ...
        self.delta = delta
        self.rho = 0 if delta == 0 else cdp_rho(epsilon, delta) / rho_divider
